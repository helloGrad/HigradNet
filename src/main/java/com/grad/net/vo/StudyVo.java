...
public class StudyVo {
	...
	public String getSubSlctnEndDt() {
		return subSlctnEndDt;
	}
	public void setSubSlctnEndDt(String subSlctnEndDt) {
		this.subSlctnEndDt = subSlctnEndDt;
	}
	@Override
	public String toString() {
		return "StudyVo [orgnzNo=" + orgnzNo + ", pCdNm=" + pCdNm + ", university=" + university + ", graduate="
				...
				+ ", researchList=" + researchList + ", no=" + no + ", reAvlblEndDt=" + reAvlblEndDt + ", avlblEndDt="
				+ avlblEndDt + ", tuitionSuprtYn=" + tuitionSuprtYn + ", lvncSuprtYn=" + lvncSuprtYn + ", incetSuprtYn="
				...
				+ eduPgmJoingSuprtYn + ", mapProfNm=" + mapProfNm + ", ar=" + ar + ", slsnMth=" + slsnMth
				+ ", slctnNops=" + slctnNops + ", chrgrNm=" + chrgrNm + ", chrgrTelNo=" + chrgrTelNo + ", chrgrEmail="
				+ chrgrEmail + ", wrtbtTypeDstnct=" + wrtbtTypeDstnct + ", ptitle=" + ptitle + ", prntsWrtbtNo="
				+ prntsWrtbtNo + ", subSlctnEndDt=" + subSlctnEndDt + "]";
	}
